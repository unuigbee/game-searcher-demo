...
open class DictionaryEncoder {
	...
	open func encode<T: Encodable>(_ value: T) throws -> NSDictionary {
		let encoder = _DictionaryEncoder(options: options)
...
private class _DictionaryEncoder: Encoder {
	...
	fileprivate init(options: DictionaryEncoder._Options, codingPath: [CodingKey] = []) {
		...
		storage = _DictionaryEncodingStorage()
	...
	public func container<Key>(keyedBy: Key.Type) -> KeyedEncodingContainer<Key> {
		...
		let container = DictionaryCodingKeyedEncodingContainer<Key>(referencing: self, codingPath: codingPath, wrapping: topContainer)
	...
	public func unkeyedContainer() -> UnkeyedEncodingContainer {
		...
		return _DictionaryUnkeyedEncodingContainer(referencing: self, codingPath: codingPath, wrapping: topContainer)
	}
...
private struct DictionaryCodingKeyedEncodingContainer<K: CodingKey>: KeyedEncodingContainerProtocol {
	...
	public mutating func nestedContainer<NestedKey>(keyedBy keyType: NestedKey.Type, forKey key: Key) -> KeyedEncodingContainer<NestedKey> {
		...
		let container = DictionaryCodingKeyedEncodingContainer<NestedKey>(referencing: encoder, codingPath: codingPath, wrapping: dictionary)
		return KeyedEncodingContainer(container)
	}
	...
	public mutating func nestedUnkeyedContainer(forKey key: Key) -> UnkeyedEncodingContainer {
		...
		codingPath.append(key)
		defer { self.codingPath.removeLast() }
		return _DictionaryUnkeyedEncodingContainer(referencing: encoder, codingPath: codingPath, wrapping: array)
	}

	public mutating func superEncoder() -> Encoder {
		_DictionaryReferencingEncoder(referencing: encoder, key: DictionaryCodingKey.super, convertedKey: _converted(DictionaryCodingKey.super), wrapping: container)
	}

	public mutating func superEncoder(forKey key: Key) -> Encoder {
		_DictionaryReferencingEncoder(referencing: encoder, key: key, convertedKey: _converted(key), wrapping: container)
	}
}
...
private struct _DictionaryUnkeyedEncodingContainer: UnkeyedEncodingContainer {
	...
	public mutating func encode(_ value: Float) throws {
		// Since the float may be invalid and throw, the coding path needs to contain this key.
		encoder.codingPath.append(DictionaryCodingKey(index: count))
		defer { self.encoder.codingPath.removeLast() }
	...
	public mutating func nestedContainer<NestedKey>(keyedBy keyType: NestedKey.Type) -> KeyedEncodingContainer<NestedKey> {
		codingPath.append(DictionaryCodingKey(index: count))
		defer { self.codingPath.removeLast() }
	...
	public mutating func superEncoder() -> Encoder {
		_DictionaryReferencingEncoder(referencing: encoder, at: container.count, wrapping: container)
	}
}
...
private extension _DictionaryEncoder {
...
private class _DictionaryReferencingEncoder: _DictionaryEncoder {
	...
	fileprivate init(referencing encoder: _DictionaryEncoder, at index: Int, wrapping array: NSMutableArray) {
		...
		codingPath.append(DictionaryCodingKey(index: index))
	}
