...
// https://github.com/CombineCommunity/CombineExt
	...
	public extension Publisher {
		...
		///
		///  - parameter other: A second publisher source.p
		///  - parameter other1: A third publisher source.
		...
		///
		///  - returns: A publisher containing the result of combining each value of the self
		///             with the latest value from the second publisher, if any
		func combineWithLatestFrom<Other: Publisher>(_ other: Other)
			-> Publishers.WithLatestFrom<Self, Other, (Output, Other.Output)>
		{
			.init(upstream: self, second: other, resultSelector: { a, b in (a, b) })
		}
	}
